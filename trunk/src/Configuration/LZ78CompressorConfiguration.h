...
#define MAX_CHILD 16777215//era 65535, provato a 1048575
...
#define HASH_TABLE_LENGTH (33554432)*sizeof(struct LZ78HashTableEntry)
#define HASH_TABLE_ENTRIES (33554432)
